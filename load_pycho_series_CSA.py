...
#%%
#directory path
#pn = r'Y:\2019\cm22979-6\processing\Merlin\Merlin\20191001_15kV_ptycho\MoS2_700C\rot_step_refine\processing\pycho'

#pn = pn +'\*.hdf'

pn = '/dls/e02/data/2020/cm26481-1/processing/pty_simulated_data_MD/sim_matrix/graphene_small_hole_25mrad_zero_def/testing_rot/06022020_20200206-132139.hdf'
#pn = pn + '\*.json'
#build list of files
...
dat_sort_fft = np.fft.fft2(dat_sort)
dat_sort_fft = np.fft.fftshift(dat_sort_fft)
d_s_fft = hs.signals.Signal2D(data = np.log(np.abs(dat_fft)))
