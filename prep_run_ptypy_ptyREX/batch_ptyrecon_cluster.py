...
#                    os.system('\n module load global/cluster \n qsub '+ script_path + 'data_prep_submit.sh '+ entry.path + ' ptypy=False ptyrex=True')
...
#                        os.system('\n cd '+ output_folder + '\n module load global/cluster \n qsub '+ script_path + 'ptypy_batch_submit.sh '+ entry.path)
    dirs_to_run_ptyREX = get_raw_dir_list(sim_matrix_path, get_all = True) # all of them!
        ...
        for entry in it:
            if entry.is_file():
                if entry.name.startswith('ptyREX'):
                    ...
                    os.system('\n cd '+ output_folder + '\n module load global/cluster \n qsub '+ script_path + 'ptyREX_batch_submit.sh '+ output_folder + ' ' + json_file + ' 06022020')
